    ...
    <div style="max-width:600px; margin:0 auto; background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
      ...
      <div style="padding:24px; color:#111827;">
        ...
        <div style="text-align:center; margin:24px 0;">
          <a href="${link}" style="background:#0388bd; color:#ffffff; padding:12px 24px; border-radius:6px; text-decoration:none; font-weight:bold; display:inline-block;">Restablecer contraseña</a>
        </div>
